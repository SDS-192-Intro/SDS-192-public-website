...
```{r eval = FALSE}
sum_x_in_df(df1, num_votes)
```

> Both `data` and `var` are required arguments above. 
...
> Default value provided for `var`, so it is now optional. 
